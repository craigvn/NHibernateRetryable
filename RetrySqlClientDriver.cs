...
namespace YoureOnTime.Data
{
	...
	/// </summary>
	public class RetrySqlClientDriver : DriverBase, IEmbeddedBatcherFactoryProvider
	{
		...
		{
			get { return typeof(RetrySqlClientBatchingBatcherFactory); }
		}
